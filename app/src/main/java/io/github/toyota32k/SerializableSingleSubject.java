 ...
 * <p>
 * <img width="640" height="236" src="https://raw.github.com/wiki/ReactiveX/RxJava/images/rx-operators/SerializableSingleSubject.png" alt="">
 * <p>
 * This subject does not have a public constructor by design; a new non-terminated instance of this
 * {@code SerializableSingleSubject} can be created via the {@link #create()} method.
 * <p>
 * Since the {@code SerializableSingleSubject} is conceptionally derived from the {@code Processor} type in the Reactive Streams specification,
 ...
 * <p>
 * Since a {@code SerializableSingleSubject} is a {@link io.reactivex.rxjava3.core.Single}, calling {@code onSuccess} or {@code onError}
 * will move this {@code SerializableSingleSubject} into its terminal state atomically.
 * <p>
 ...
 * <p>
 * Even though {@code SerializableSingleSubject} implements the {@code SingleObserver} interface, calling
 * {@code onSubscribe} is not required (<a href="https://github.com/reactive-streams/reactive-streams-jvm#2.12">Rule 2.12</a>)
 * if the subject is used as a standalone source. However, calling {@code onSubscribe}
 * after the {@code SerializableSingleSubject} reached its terminal state will result in the
 * given {@code Disposable} being disposed immediately.
 * <p>
 * This {@code SerializableSingleSubject} supports the standard state-peeking methods {@link #hasThrowable()},
 ...
 * <p>
 * The {@code SerializableSingleSubject} does not support clearing its cached {@code onSuccess} value.
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code SerializableSingleSubject} does not operate by default on a particular {@link io.reactivex.rxjava3.core.Scheduler} and
 ...
 *  <dd>When the {@link #onError(Throwable)} is called, the {@code SerializableSingleSubject} enters into a terminal state
 ...
 *  cancel at once).
 *  If there were no {@code SingleObserver}s subscribed to this {@code SerializableSingleSubject} when the {@code onError()}
 ...
 * Example usage:
 * <pre><code>
 * SerializableSingleSubject&lt;Integer&gt; subject1 = SerializableSingleSubject.create();
 *
 * TestObserver&lt;Integer&gt; to1 = subject1.test();
 *
 * // SerializableSingleSubjects are empty by default
 * to1.assertEmpty();
 *
 * subject1.onSuccess(1);
 *
 * // onSuccess is a terminal event with SerializableSingleSubjects
...
public final class SerializableSingleSubject<T> extends Single<T> implements SingleObserver<T>, Serializable {
    ...
    /**
     * Creates a fresh SerializableSingleSubject.
     * @param <T> the value type received and emitted
     * @return the new SerializableSingleSubject instance
     */
    @CheckReturnValue
    @NonNull
    public static <T> SerializableSingleSubject<T> create() {
        return new SerializableSingleSubject<>();
    }
    ...
    /**
     * Returns the success value if this SerializableSingleSubject was terminated with a success value.
    ...
    /**
     * Returns true if this SerializableSingleSubject was terminated with a success value.
     * @return true if this SerializableSingleSubject was terminated with a success value
     */
    ...
    /**
     * Returns the terminal error if this SerializableSingleSubject has been terminated with an error, null otherwise.
    ...
    /**
     * Returns true if this SerializableSingleSubject has been terminated with an error.
     * @return true if this SerializableSingleSubject has been terminated with an error
     */
    ...
    /**
     * Returns true if this SerializableSingleSubject has observers.
     * @return true if this SerializableSingleSubject has observers
     */
    ...
    static final class SingleDisposable<T>
            extends AtomicReference<SerializableSingleSubject<T>> implements Disposable {
        private static final long serialVersionUID = -7650903191002190468L;

        final SingleObserver<? super T> downstream;

        SingleDisposable(SingleObserver<? super T> actual, SerializableSingleSubject<T> parent) {
        ...
        @Override
        public void dispose() {
            SerializableSingleSubject<T> parent = getAndSet(null);
            if (parent != null) {
                parent.remove(this);
            }
        }
